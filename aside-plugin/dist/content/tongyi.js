...
(function() {
  ...
  class TongyiAdapter extends BaseAdapter {
    constructor() {
      super(...arguments);
      __publicField(this, "platform", "tongyi");
    }
    detectPlatform() {
    ...
    parseMessages() {
      ...
      allTurns.forEach((el, i) => {
        var _a;
        const role = el.matches(USER_SEL) ? "user" : "assistant";
        const content = ((_a = el.textContent) == null ? void 0 : _a.trim()) ?? "";
        if (!content) return;
